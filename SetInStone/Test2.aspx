<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Test2.aspx.cs" Inherits="SetInStone.Test2" %>
    ...
    <script type="text/javascript">
        ...
        function init() {
            ...
            function render() {
                ...
                var vertices = [];
                for (var i = 0; i < 8; i++) {
                    vertices.push(new THREE.Vector3(controlPoints[i].x, controlPoints[0,1,3,4].y, controlPoints[i].z));
                    //vertices.push(new THREE.Vector3(controlPoints[0, 1].x, controlPoints[0, 1].y, controlPoints[0, 1].z));
                }
