<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="test2.aspx.cs" Inherits="SetInStone.App_Start.test2" %>
...
<head>
   ...
   <link rel="stylesheet" type="text/css" href="css/styles.css" />
    ...
    <%: Styles.Render("~/Content/bootstrap.css") %><%: Scripts.Render("~/bundles/jQuery") %>
	...
	<script type="text/javascript">
	    ...
	    initScene = function () {
	        ...
	        table_material = Physijs.createMaterial(
                new THREE.MeshLambertMaterial({ map: THREE.ImageUtils.loadTexture('Textures/granite2.jpg'), ambient: 0xFFFFFF }),
                .9, // high friction
                .2 // low restitution
            );
	        ...
	        block_material = Physijs.createMaterial(
                new THREE.MeshLambertMaterial({ map: THREE.ImageUtils.loadTexture('Textures/sandstone2.jpg'), ambient: 0xFFFFFF }),
                .4, // medium friction
...
<body>
	<div id="heading">
		<h1>Jenga - <a href="http://chandlerprall.github.com/Physijs/">Physijs</a></h1>
